# #using the ssl module instead now
#
...
#         return days_left
#
#     except (AlreadyExpired, ConnectionRefusedError):
...
#         if not suppressErrors or smash_vars.verbose:
...
#         print("\n!! Invalid certificate / certificate doesn't exist for {}".format(hostname))
#         raise
