...
webfaction_user = smash_vars.servers["sebodev"]["ssh-username"]
webfaction_passwd = smash_vars.servers["sebodev"]["ssh-password"]

website_name = smash_vars.current_project.replace(' ', '')
